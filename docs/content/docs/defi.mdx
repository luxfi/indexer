...
```
GET /v1/explorer/defi/pools
GET /v1/explorer/defi/pools/{address}
GET /v1/explorer/defi/pools/{address}/swaps
GET /v1/explorer/defi/positions/{address}
GET /v1/explorer/defi/market/{pair}/candles
GET /v1/explorer/defi/stats
```
