...
LUX_C_RPC=http://127.0.0.1:9630/v1/bc/C/rpc
LUX_P_RPC=http://127.0.0.1:9630/v1/bc/P
LUX_X_RPC=http://127.0.0.1:9630/v1/bc/X
...
```yaml
rpc:
  c_chain: http://127.0.0.1:9630/v1/bc/C/rpc
  p_chain: http://127.0.0.1:9630/v1/bc/P
  x_chain: http://127.0.0.1:9630/v1/bc/X
...
```bash
LUX_NETWORK=local
LUX_C_RPC=http://127.0.0.1:9650/v1/bc/C/rpc
```
