...
const networks = [
  { label: 'Devnet', domain: 'explore.dev.example.internal', chainId: 8675311 },
  { label: 'Testnet', domain: 'explore.test.example.internal', chainId: 8675310 },
  { label: 'Mainnet', domain: 'explore.example.internal', chainId: 8675309 },
] as const
