...
//  event topic0 signatures (keccak256 hashes).
//
// Source contracts:
...
// LiquidityProtocolTopics returns all  event topic0 strings.
...
// OmniSwapEvent represents a parsed  event.
...
// ParseOmniSwapEvents extracts  events from EVM logs.
